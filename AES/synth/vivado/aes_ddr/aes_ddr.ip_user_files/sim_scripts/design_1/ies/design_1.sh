...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../aes_ddr.srcs/sources_1/bd/design_1/ipshared/65a4" \
       +incdir+"$ref_dir/../../../../aes_ddr.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../aes_ddr.srcs/sources_1/bd/design_1/ipshared/65a4" \
       +incdir+"../../../../aes_ddr.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl"
}
